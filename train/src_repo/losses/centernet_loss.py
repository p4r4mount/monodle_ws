...
from losses.focal_loss import focal_loss_cornernet
from losses.uncertainty_loss import laplacian_aleatoric_uncertainty_loss
from losses.dim_aware_loss import dim_aware_l1_loss
...
if __name__ == '__main__':
    ...
    print(compute_heading_loss(a,b,c))